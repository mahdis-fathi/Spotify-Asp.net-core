...
$(document).ready(function () {
    $(".play-btn").on("click", function () {
        ...
        var albumArtUrl = $(this).find(".album-art").attr("src");

        var playerContent = $("#player-content");
        var albumArt = playerContent.find("#album-art");
        var albumArtImg = albumArt.find("img.active");

        // Update album artwork and song URL in the player
        albumArtImg.attr("src", albumArtUrl.replace("_", songUrl));
        playerContent.data("song-url", songUrl);

        // Update other player elements as needed
        // ...

        // Trigger play/pause action in the player if desired
        // ...
    });
});
...
$(function () {
    ...
    function selectTrack(flag) {
        ...
        if (currIndex > -1 && currIndex < albumArtworks.length) {
            if (flag == 0) playPauseButton.attr("src", "/img/play.svg"); else {
                albumArt.removeClass("buffering");
                playPauseButton.attr("src", "/img/pause.svg");;
            }
